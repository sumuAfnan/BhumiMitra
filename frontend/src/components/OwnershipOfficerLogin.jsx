...
const OwnershipOfficerLogin = () => {
  const [loginData, setLoginData] = useState({
    email: '',
    password: '',
    role: 'Ownership Transfer Officer', // ✅ Role automatically set
  });
  ...
  const handleSubmit = (e) => {
    ...
    alert('Ownership Transfer Officer login successful!');

    // ✅ Redirect to OwnershipOfficerPortal
    navigate('/OwnershipOfficer');
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-100 p-4">
      <div className="w-full max-w-md bg-white shadow-md rounded-md p-8">
        ...
        <h2 className="text-base font-semibold mb-3 text-gray-700 text-center">
          Ownership Transfer Officer Login
        </h2>
...
export default OwnershipOfficerLogin;
